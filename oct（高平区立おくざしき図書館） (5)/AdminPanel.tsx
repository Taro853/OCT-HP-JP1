...
import { Book, NewsItem, Notice, ClosedDate, MonthlyFeature, SurveyQuestion, Reservation } from './types';
import { Layout, Bell, BookOpen, UserCheck, Calendar as CalendarIcon, Edit2 } from 'lucide-react';
...
type Tab = 'news' | 'notices' | 'books' | 'dates' | 'reservations' | 'feature';

export const AdminPanel: React.FC<AdminPanelProps> = ({
  books, news, notices, closedDates, feature, reservations
}) => {
  ...
  return (
    <div className="space-y-8 pb-20 font-serif max-w-7xl mx-auto px-4 bg-[#fcfcfc] min-h-screen">
      ...
      <div className="bg-white rounded-[2rem] shadow-xl border border-oct-100 p-8 min-h-[700px]">
        ...
        {activeTab === 'news' && <AdminNewsTab news={news} />}
        {activeTab === 'notices' && <AdminNoticesTab notices={notices} />}
