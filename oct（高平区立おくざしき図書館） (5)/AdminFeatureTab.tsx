...
export const AdminFeatureTab: React.FC<AdminFeatureTabProps> = ({ feature }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in relative">
      ...
      {/* Editor Modal */}
      {isEditing && (
        <div className="fixed inset-0 z-50 bg-oct-900/60 backdrop-blur-sm flex items-center justify-center p-4" onClick={(e) => { if (e.target === e.currentTarget) setIsEditing(false) }}>
           <div className="bg-white w-full max-w-4xl h-[85vh] rounded-[3rem] shadow-2xl flex flex-col overflow-hidden animate-slide-up ring-4 ring-white/20">
              {/* Header */}
              <div className="p-6 border-b border-oct-100 flex justify-between items-center bg-oct-50">
              ...
              <div className="flex-1 overflow-y-auto p-10 space-y-10">
                 ...
                 <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full text-3xl font-bold text-oct-950 py-2 bg-transparent outline-none placeholder-oct-200 text-center font-serif"
                      placeholder="記事タイトル"
                    />
